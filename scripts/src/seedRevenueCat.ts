...
const PROJECT_NAME = "3-6-9 Manifestation Companion";

const PRODUCT_IDENTIFIER = "premium_lifetime";
const PRODUCT_DISPLAY_NAME = "Premium Lifetime";
const PRODUCT_USER_FACING_TITLE = "Premium – Unlock Inspire";

const APP_STORE_APP_NAME = "3-6-9 Manifestation Companion iOS";
const APP_STORE_BUNDLE_ID = "com.manifestation.companion";
const PLAY_STORE_APP_NAME = "3-6-9 Manifestation Companion Android";
const PLAY_STORE_PACKAGE_NAME = "com.manifestation.companion";
...
const PACKAGE_DISPLAY_NAME = "Lifetime Unlock";
...
async function seedRevenueCat() {
  ...
  const playStoreProduct = await ensureProductForApp(playStoreApp, "Play Store", PRODUCT_IDENTIFIER, false);

  // Add test store prices (£2.99 GBP as primary, plus USD/EUR equivalents)
