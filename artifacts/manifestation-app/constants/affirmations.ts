...
export const MANIFEST_CATEGORIES: AffirmationCategory[] = [
  {
    id: "m-wealth",
...
export const ALL_MANIFEST_SPARKS: string[] = MANIFEST_CATEGORIES.flatMap((c) => c.items);
